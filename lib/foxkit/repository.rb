module Foxkit
  ...
  # Class to parse GitLab repository owner and name from
  # URLs and to generate URLs
  class Repository
    attr_accessor :owner, :name, :id

    # Instantiate from a GitLab repository URL
    #
    # @return [Repository]
    ...
    # @param repo [Integer, String, Hash, Repository] A GitLab repository.
